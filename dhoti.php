  ...
  <div class="container-fluid">
    ...
    <li><a href="logout.php"><i class="fa fa-user fa-2x"></i><span class="icon-text"> <span class="glyphicon glyphicon-log-out"style="color:#000000"></span><span class="icon-text" style="color:#000000">  Logout  </span> </a></li>
          ...
          <div class="container" style=" margin-top:30px">
            <div class="jumbotron" style="background-image: url(img/white.jpg);">
			 
				<h1 style="padding-bottom:10px">Dhotis</h1></div>
        ...
        <div class="container">
            <div class="row" >
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/Deyann-Dupion-Silk-Maroon-Dhoti.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>Deyann-Silk-Maroon-Dhoti</h4><p>Price:Rs.859.00</p></div>
                             <?php if (!isset($_SESSION['email'])) { ?>
                                ...
                                if (check_if_added_to_cart(13)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=13" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
                 ...
                 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/Deyann-Dupion-Silk-Navy-Blue-Patiala.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>Deyann-Dupion-Silk-Patiala</h4><p>Price:Rs.2274.00</p></div>
                             <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(14)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=14" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
                 ...
                 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/MANISH CREATIONS.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>MANISH CREATIONS</h4><p>Price:Rs.1000.00</p></div>
                             <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(15)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=15" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
		 ...
		 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/MANYAVAR-DHOTIS.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>MANYAVAR-DHOTIS</h4><p>Price:Rs.2500.00</p></div>
                             <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(16)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=16" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
               ...
               <div class="row">
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/Navy-Blue-Solid-Dhoti.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>Navy-Blue-Solid-Dhoti</h4><p>Price:Rs.800.00</p></div>
                              <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(17)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=17" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
                 ...
                 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/Sethukrishna-Men-Cream-Coloured-Solid-Readymade-Dhoti.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>Sethukrishna-Dhoti</h4><p>Price:Rs.1674.00</p></div>
                             <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(18)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=18" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
                 ...
                 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/Sethukrishna-Men-Readymade-Dhoti.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>Sethukrishna-Dhoti</h4><p>Price:Rs.1090.00</p></div>
                              <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(19)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=19" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
		 ...
		 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/SOJANYA-Men-Dhotis.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>SOJANYA-Men-Dhotis</h4><p>Price:Rs.1300.00</p></div>
                              <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(20)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=20" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
			  ...
			  <div class="row">
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/SOJANYA-Men-Maroon-Dhoti-Pants.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>SOJANYA-Men-Maroon-Dhoti-Pants</h4><p>Price:Rs.1300.00</p></div>
                              <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(21)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=21" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
                 ...
                 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/SOJANYA-Men-Off-White-Dhoti-Pants.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>SOJANYA-White-Dhoti-Pants</h4><p>Price:Rs.1674.00</p></div>
                             <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(22)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=22" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
                 ...
                 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/-Sojanya-Since-1958-Stitched-Orange-Mens-Dhoti.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>Sojanya-Stitched-Orange-Mens-Dhoti</h4><p>Price:Rs.3000.00</p></div>
                             <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(23)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=23" class="btn btn-block btn-success" >Added to cart</a>';
                                } else {
                                    ?>
		 ...
		 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="thumbnail">
                        <img src="img/men/dhoti/VASTRAMAY-Men-Maroon-Solid-Dhoti-Pants.jpg" alt="responsive image">
                          <div class="caption" style="text-align: center"><h4>VASTRAMAY-Men-Maroon-Solid-Dhoti-Pants</h4><p>Price:Rs.2700.00</p></div>
                             <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="index.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                                ...
                                if (check_if_added_to_cart(24)) { //This is same as if(check_if_added_to_cart != 0)
                                    echo '<a href="cart-add.php?id=24" class="btn btn-block btn-success">Added to cart</a>';
                                } else {
                                    ?>
